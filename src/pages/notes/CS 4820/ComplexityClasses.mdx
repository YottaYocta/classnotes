...
- create a set cover instance where ground set (\\(U\\)) is equal to the all verteces. each subset \\(S_i\\) corresponds with all the edges that would be covered if \\(v_i\\) were included
