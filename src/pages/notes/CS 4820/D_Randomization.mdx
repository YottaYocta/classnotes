...
In other words, single run of Contraction Algo fails to find global min with probability \\(1 - 1 / \binom n 2\\)

We can increase probabilities of success by running algorithm multiple times
